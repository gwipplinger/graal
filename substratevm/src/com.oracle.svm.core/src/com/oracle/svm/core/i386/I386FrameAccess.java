...
import org.graalvm.nativeimage.Platform.I386;
...
@AutomaticFeature
@Platforms(I386.class)
class I386FrameAccessFeature implements Feature {
    @Override
    public void afterRegistration(AfterRegistrationAccess access) {
        ImageSingletons.add(FrameAccess.class, new I386FrameAccess());
    }
}

@Platforms(I386.class)
public final class I386FrameAccess extends FrameAccess {
