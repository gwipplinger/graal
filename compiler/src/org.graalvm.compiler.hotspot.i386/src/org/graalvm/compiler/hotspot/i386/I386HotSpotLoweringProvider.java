...
import org.graalvm.compiler.core.i386.I386LoweringProviderMixin;
...
public class I386HotSpotLoweringProvider extends DefaultHotSpotLoweringProvider implements I386LoweringProviderMixin {
...
//!    private AMD64X87MathSnippets.Templates mathSnippets;
    ...
    public I386HotSpotLoweringProvider(HotSpotGraalRuntimeProvider runtime, MetaAccessProvider metaAccess, ForeignCallsProvider foreignCalls, HotSpotRegistersProvider registers,
