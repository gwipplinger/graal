...
public class I386GraphBuilderPlugins implements TargetGraphBuilderPlugins {
    @Override
    public void register(Plugins plugins, Replacements replacements, Architecture architecture, boolean registerForeignCallMath, boolean useFMAIntrinsics, OptionValues options) {
        register(plugins, replacements, (I386) architecture, useFMAIntrinsics, options);
    }

    public static void register(Plugins plugins, Replacements replacements, I386 arch, boolean useFMAIntrinsics, OptionValues options) {
/*
